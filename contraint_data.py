...
nd_lo, nd_hi = 0.20, 0.35
b_lo,  b_hi  = 0.001, 0.02
...
# ── Save Wide Format ─────────────────────────────────────────────────────────
df.to_excel('FeNdB_ML_dataset_constrained.xlsx', index=False)
df.to_csv('FeNdB_ML_dataset_constrained.csv', index=False)
print('Saved wide format: FeNdB_ML_dataset_constrained.xlsx / .csv')
...
df_long.to_csv('FeNdB_ML_dataset_long_constrained.csv', index=False)
print('Saved long format: FeNdB_ML_dataset_long_constrained.csv')